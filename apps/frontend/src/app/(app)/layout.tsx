    ...
    <html className={interClass}>
      ...
      <body className={clsx(chakra.className, 'dark text-primary !bg-primary')}>
        ...
        <VariableContextComponent
          ...
          genericOauth={!!process.env.SPECTERS_GENERIC_OAUTH}
          oauthLogoUrl={process.env.NEXT_PUBLIC_SPECTERS_OAUTH_LOGO_URL!}
          oauthDisplayName={process.env.NEXT_PUBLIC_SPECTERS_OAUTH_DISPLAY_NAME!}
        ...
        >
          ...
          <FacebookComponent />
          <Plausible
            domain={!!process.env.IS_GENERAL ? 'specters.com' : 'gitroom.com'}
          >
            <PHProvider
